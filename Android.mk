...
ifneq ($(filter athe,$(TARGET_DEVICE)),)
...
LOCAL_MODULE_OWNER := huawei
LOCAL_SRC_FILES_64 := system/lib64/libloc_api_v02.so
LOCAL_SRC_FILES_32 := system/lib/libloc_api_v02.so
LOCAL_MODULE_TAGS := optional
...
LOCAL_MODULE_OWNER := huawei
LOCAL_SRC_FILES_64 := system/lib64/libloc_ds_api.so
LOCAL_SRC_FILES_32 := system/lib/libloc_ds_api.so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH_64 := $(TARGET_OUT_SHARED_LIBRARIES)
...
LOCAL_MODULE_OWNER := huawei
LOCAL_SRC_FILES_64 := system/lib64/libqmi_oem_api.so
LOCAL_SRC_FILES_32 := system/lib/libqmi_oem_api.so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH_64 := $(TARGET_OUT_SHARED_LIBRARIES)
...
LOCAL_MODULE_OWNER := huawei
LOCAL_SRC_FILES_64 := system/vendor/lib64/libmm-abl.so
LOCAL_SRC_FILES_32 := system/vendor/lib/libmm-abl.so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
